...
public class SingleItemActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public AppCompatTextView productName, productPrice,productDPrice, prodctDescription,productWeight;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linearLayout = findViewById(R.id.sinle_qulayout);
        ProductImage = (ImageView) findViewById(R.id.singleprimage);
        productName = findViewById(R.id.singlepname);
        productDPrice = findViewById(R.id.singlepdiscprice);
        productPrice = findViewById(R.id.singlepprice);
        productWeight = findViewById(R.id.singlweight);
    ...
    private void initialize() {
        ...
        if(prices.size() == 1){
            ...
            pricesSpinner.setVisibility(View.GONE);
